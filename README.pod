...
Text::Roman - Converts Roman digits to integer numbers and the contrary, recognize digits
...
=head2 mroman2int($str) / milhar2int($str)

Return '' if C<$str> is not Roman or return integer if it is.
(milhar support)

=head2 ismroman($str) / ismilhar($str)
